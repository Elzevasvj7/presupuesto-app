  ...
  return (
    <div>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <div className="bg-white rounded-lg p-4 border-l-4 border-[#E8BF8B] shadow-sm">
          <p className="text-sm text-gray-600 mb-1">Presupuesto total</p>
          <p className="text-2xl font-bold text-[#E8BF8B]">
            ${income.toFixed(2)}
          </p>
          <p className="text-xs text-gray-500 mt-1">100% del presupuesto</p>
        </div>
